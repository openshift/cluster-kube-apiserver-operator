...
%global package_name origin-cluster-kube-apiserver-operator
%global product_name OpenShift Cluster kube-apiserver Operator
%global import_path github.com/openshift/cluster-kube-apiserver-operator
...
for bin in cluster-kube-apiserver-operator
do
  echo "+++ INSTALLING ${bin}"
...
%doc README.md
%license LICENSE
%{_bindir}/cluster-kube-apiserver-operator
