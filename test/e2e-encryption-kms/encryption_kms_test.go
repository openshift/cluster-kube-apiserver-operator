...
var SupportedStaticEncryptionProviders = []configv1.EncryptionType{configv1.EncryptionTypeAESGCM, configv1.EncryptionTypeAESCBC}
...
func TestKMSEncryptionProvidersMigration(t *testing.T) {
	...
	library.TestEncryptionProvidersMigration(t, library.ProvidersMigrationScenario{
		...
		ResourceFunc:                   operatorencryption.SecretOfLife,
		ResourceName:                   "SecretOfLife",
		EncryptionProviders:            library.ShuffleEncryptionProviders([]configv1.EncryptionType{configv1.EncryptionTypeKMS, SupportedStaticEncryptionProviders[rand.IntN(len(SupportedStaticEncryptionProviders))]}),
	})
}
