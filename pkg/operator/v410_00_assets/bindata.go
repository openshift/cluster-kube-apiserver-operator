...
var _v410KubeApiserverConfigOverridesYaml = []byte(`apiVersion: kubecontrolplane.config.openshift.io/v1
...
func v410KubeApiserverConfigOverridesYamlBytes() ([]byte, error) {
	return _v410KubeApiserverConfigOverridesYaml, nil
}

func v410KubeApiserverConfigOverridesYaml() (*asset, error) {
	bytes, err := v410KubeApiserverConfigOverridesYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "v4.1.0/kube-apiserver/config-overrides.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"v4.1.0/kube-apiserver/config-overrides.yaml":              v410KubeApiserverConfigOverridesYaml,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"v4.1.0": {nil, map[string]*bintree{
		"kube-apiserver": {nil, map[string]*bintree{
			...
			"config-overrides.yaml":              {v410KubeApiserverConfigOverridesYaml, map[string]*bintree{}},
