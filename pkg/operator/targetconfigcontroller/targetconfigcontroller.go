...
func createTargetConfig(ctx context.Context, c TargetConfigController, recorder events.Recorder, operatorSpec *operatorv1.StaticPodOperatorSpec) (bool, error) {
	...
	if err := checkExternalDependencies(c.configMapLister, recorder); err != nil {
...
func checkExternalDependencies(lister corev1listers.ConfigMapLister, recorder events.Recorder) error {
