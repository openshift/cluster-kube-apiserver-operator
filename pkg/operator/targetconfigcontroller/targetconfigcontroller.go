...
func managePods(ctx context.Context, client coreclientv1.ConfigMapsGetter, infrastructureLister configlistersv1.InfrastructureLister, recorder events.Recorder, operatorSpec *operatorv1.StaticPodOperatorSpec, imagePullSpec, operatorImagePullSpec string) (*corev1.ConfigMap, bool, error) {
	...
	startupMonitorPodKey, optionalStartupMonitor, err := manageOptionalStartupMonitorPod(infrastructureLister, operatorSpec, operatorImagePullSpec)
	if err != nil {
...
func manageOptionalStartupMonitorPod(infrastructureLister configlistersv1.InfrastructureLister, operatorSpec *operatorv1.StaticPodOperatorSpec, operatorImagePullSpec string) (string, *corev1.Pod, error) {
	...
	appliedStartupMonitorPodTemplate, err := startupmonitor.ManagePodTemplate(operatorSpec, operatorclient.TargetNamespace, "kube-apiserver", operatorImagePullSpec)
	if err != nil {
		return "", nil, err
	}
