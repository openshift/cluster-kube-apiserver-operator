...
type EventRecorder struct {
	...
	testingEventRecorder *eventstesting.TestingEventRecorder
}

func NewEventRecorder(t *testing.T, r events.Recorder) events.Recorder {
	return &EventRecorder{
		testingEventRecorder: eventstesting.NewTestingEventRecorder(t).(*eventstesting.TestingEventRecorder),
		realEventRecorder:    r,
	}
}
