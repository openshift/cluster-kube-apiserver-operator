...
// copied from: https://github.com/openshift/cluster-kube-apiserver-operator/blob/release-4.13/vendor/github.com/openshift/library-go/pkg/operator/encryption/preconditions.go
