...
replace github.com/openshift/library-go => github.com/deads2k/library-go v0.0.0-20230320202300-7cca762cd047

replace github.com/openshift/api => github.com/deads2k/api v0.0.0-20230213220546-d24a78bbb903
