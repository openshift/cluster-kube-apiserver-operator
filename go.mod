...
// Temporary: Add diagnostics logging to pod stabilization helpers
replace github.com/openshift/library-go => github.com/gangwgr/library-go v0.0.0-20260216081231-199c1d8218cd
