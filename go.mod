...
require (
	...
	github.com/openshift/library-go v0.0.0-20211214141842-7bcd82848eb9
...
replace github.com/openshift/library-go => github.com/jerpeter1/library-go v0.0.0-20211218010113-583f8a3fe641
