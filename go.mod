...
require (
	...
	github.com/openshift/library-go v0.0.0-20191108163453-b6ade03f7b53
...
replace (
	...
	github.com/openshift/library-go => github.com/openshift/library-go v0.0.0-20191108163453-b6ade03f7b53
