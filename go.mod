...
require (
	...
	github.com/openshift/library-go v0.0.0-20260611043026-d676f19b8c59
...
replace github.com/openshift/library-go => github.com/ardaguclu/library-go v0.0.0-20260611061342-46eaba231e7f
