...
require (
	...
	github.com/openshift/library-go v0.0.0-20200128172308-5750470ea89b
...
replace (
	...
	github.com/openshift/library-go => github.com/mfojtik/library-go v0.0.0-20200128201726-223cadbd908b
