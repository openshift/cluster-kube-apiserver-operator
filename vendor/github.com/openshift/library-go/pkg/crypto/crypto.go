...
// Ciphers in this map must also be compatible with go's crypto/tls ciphers: https://github.com/golang/go/blob/d4febb45179fa99ee1d5783bcb693ed7ba14115c/src/crypto/tls/cipher_suites.go#L682-L724
var openSSLToIANACiphersMap = map[string]string{
	...
	// NOTE: Ciphers Removed - Go's crypto/tls does not support CBC mode ciphers (see https://github.com/golang/go/issues/26652)
	// More context: https://redhat-internal.slack.com/archives/C098FU5MRAB/p1770309657097269
	//
	...
	// NOTE: Ciphers Removed - Go's crypto/tls does not support DHE ciphers (see https://github.com/golang/go/issues/7758)
	// More context: https://redhat-internal.slack.com/archives/C098FU5MRAB/p1770309657097269
	//
