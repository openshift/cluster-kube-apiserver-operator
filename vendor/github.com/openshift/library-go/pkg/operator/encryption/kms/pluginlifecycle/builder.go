...
func NewKMSPluginBuilder(featureGateAccessor featuregates.FeatureGateAccess) *KMSPluginBuilder {
...
func fetchEncryptionConfig(ctx context.Context, encryptionConfigNamespace, encryptionConfigSecretName string, secretClient corev1client.SecretsGetter, featureGateAccessor featuregates.FeatureGateAccess) (*encryptiondata.Config, error) {
