...
func NewObserveFeatureFlagsFunc(featureWhitelist sets.String, featureBlacklist sets.String, configPath []string, featureGateAccess FeatureGateAccess) configobserver.ObserveConfigFunc {
	return (&featureFlags{
...
func (f *featureFlags) getWhitelistedFeatureNames(enabledFeatures, disabledFeatures []string) []string {
