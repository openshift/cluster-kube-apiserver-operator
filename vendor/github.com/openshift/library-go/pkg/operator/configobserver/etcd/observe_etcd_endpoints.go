...
// ObserveStorageURLsWithAlwaysLocal observes the storage config URLs and sets storageConfig field in the observerConfig.
...
// ObserveStorageURLsToArgumentsWithAlwaysLocal observes the storage config URLs and sets storageConfig field in the observerConfig.
