...
type ClusterMonitoringInformer interface {
	...
	Lister() configv1.ClusterMonitoringLister
}
...
func (f *clusterMonitoringInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiconfigv1.ClusterMonitoring{}, f.defaultInformer)
}

func (f *clusterMonitoringInformer) Lister() configv1.ClusterMonitoringLister {
	return configv1.NewClusterMonitoringLister(f.Informer().GetIndexer())
}
