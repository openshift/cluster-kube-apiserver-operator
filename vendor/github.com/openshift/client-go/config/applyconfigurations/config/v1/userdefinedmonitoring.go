...
type UserDefinedMonitoringApplyConfiguration struct {
	Mode *configv1.UserDefinedMode `json:"mode,omitempty"`
}
...
func (b *UserDefinedMonitoringApplyConfiguration) WithMode(value configv1.UserDefinedMode) *UserDefinedMonitoringApplyConfiguration {
	b.Mode = &value
	return b
}
