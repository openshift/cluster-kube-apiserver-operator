...
func ExtractPKI(pKI *configv1alpha1.PKI, fieldManager string) (*PKIApplyConfiguration, error) {
	return extractPKI(pKI, fieldManager, "")
}

// ExtractPKIStatus is the same as ExtractPKI except
// that it extracts the status subresource applied configuration.
// Experimental!
func ExtractPKIStatus(pKI *configv1alpha1.PKI, fieldManager string) (*PKIApplyConfiguration, error) {
	return extractPKI(pKI, fieldManager, "status")
}

func extractPKI(pKI *configv1alpha1.PKI, fieldManager string, subresource string) (*PKIApplyConfiguration, error) {
	b := &PKIApplyConfiguration{}
